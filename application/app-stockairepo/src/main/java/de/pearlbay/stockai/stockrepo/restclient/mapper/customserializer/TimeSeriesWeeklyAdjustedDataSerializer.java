...
/**
 * TimeSeriesWeeklyAdjustedDataSerializer.
 * Note :  adjusted, divident and plit coefficient are not implemented.
 *
 * @author joern ross (pearlbay) 2020
 */
public class TimeSeriesWeeklyAdjustedDataSerializer extends StockTimeSeriesDataCustomSerializer {


    protected TimeSeriesWeeklyAdjustedDataSerializer(JavaType valueType) {
        super(valueType);
    }

    public TimeSeriesWeeklyAdjustedDataSerializer(Class<?> vc) {
        super(vc);
    }

    public TimeSeriesWeeklyAdjustedDataSerializer(StdDeserializer<?> src) {
        super(src);
    }
